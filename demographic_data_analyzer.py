...
def calculate_demographic_data(print_data=True):
    ...
    bachelors_count = df[df['education'] == 'Bachelors'].shape[0] # Filter the dataset for people with a Bachelor's degree
    ...
    highest_earning_country = (country_earnings / country_total).idxmax()
